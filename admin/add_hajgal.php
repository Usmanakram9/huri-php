...
include 'db.php';
  ...
  if (isset($_POST['submit'])) { // if save button on the form is clicked
    ...
    if (!in_array($extension, ['png', 'jpg', 'jpeg'])) {
     ...
     $insertQuery  = "INSERT INTO tblhaj_gal (picname,picdest) VALUES ('$filename','$destination')";
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
                    Home</a> <a href="#" class="tip-bottom">Add Hajj Gallery</a> </div>
            <h1>Add Hajj Gallery</h1>
        </div>
                ...
                <div class="span12">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="add_hajgal.php" method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
