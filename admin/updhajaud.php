...
$result = mysqli_query($con,"SELECT * FROM tblhaj_aud WHERE tblhajaud_id='$id'");
    ...
    if ($_FILES['img']['name'] == "")
{
    // cover_image is empty (and not an error)
     ...
     $insertQuery  = "update tblhaj_aud set hajaud_descrip='$_POST[des]',aud_type='$_POST[audtype]' where tblhajaud_id='$_POST[bid]'";
		if($stmt = $con->prepare($insertQuery)){
			$stmt->bind_param("ss",$_POST['des'],$_POST['audtype']);
			$stmt->execute();
             header('Location:viewhaud.php?success=1');
            }
         else {
 ...
 else
 {
    ...
    if (!in_array($extension, ['mp3'])) {
     ...
     $insertQuery  = "update tblhaj_aud set hajaud_descrip='$_POST[des]',hajaud_nam='$filename',hajaud_path='$destination',aud_type='$_POST[audtype]' where tblhajaud_id='$_POST[bid]'";
		if($stmt = $con->prepare($insertQuery)){
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
                    Home</a> <a href="#" class="tip-bottom">Update Hajj Audio</a> </div>
            <h1>Update Hajj Audio</h1>
        </div>
                ...
                <div class="span12">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="updhajaud.php" method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                               <div class="control-group">
                                    <!--<label class="control-label">ID</label>-->
                                    <div class="controls">
                                        <input type="text" class="span11" name="bid" id="bid" value="<?php echo $row['tblhajaud_id'];?>" style="visibility:hidden;"/>
                                    </div>
                                </div>
                                 <div class="control-group">
                                    <label class="control-label">Description</label>
                                    <div class="controls">
                                        <input type="text" class="span11" name="des" id="des" value="<?php echo $row['hajaud_descrip'];?>" required="required" placeholder="Description" />
                                    </div>
                                </div>
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" name="img" id="img"/> <label><?php echo $row['hajaud_nam'];?></label>
                                    </div>
                                </div>
                                <div class="control-group">
