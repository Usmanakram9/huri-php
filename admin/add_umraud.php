...
include 'db.php';
  ...
  if (isset($_POST['submit'])) { // if save button on the form is clicked
    ...
    if (!in_array($extension, ['mp3'])) {
     ...
     $insertQuery  = "INSERT INTO tblumr_aud (umraud_descrip,umraud_nam,umraud_path,aud_type) VALUES ('$_POST[des]','$filename','$destination','$_POST[audtype]')";
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
                    Home</a> <a href="#" class="tip-bottom">Add Umrah Audio</a> </div>
            <h1>Add Umrah Audio</h1>
        </div>
                ...
                <div class="span12">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="add_umraud.php" method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
