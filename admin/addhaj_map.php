...
include 'db.php';
  ...
  if (isset($_POST['submit'])) { // if save button on the form is clicked
     ...
     $insertQuery  = "INSERT INTO tblhaj_map (hajdir,map_nam,map_city) VALUES ('$_POST[madd]','$_POST[pnam]','$_POST[cit]')";
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
                    Home</a> <a href="#" class="tip-bottom">Add Hajj Map</a> </div>
            <h1>Add Hajj Map</h1>
        </div>
                ...
                <div class="span12">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="addhaj_map.php" method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
