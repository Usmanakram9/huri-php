...
include 'db.php';
  ...
  if (isset($_POST['submit'])) { // if save button on the form is clicked
     ...
     $insertQuery  = "INSERT INTO tblumr_vdo (uvdo_link,uvdo_titl,uvdo_des) VALUES ('$_POST[madd]','$_POST[pnam]','$_POST[cit]')";
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
                    Home</a> <a href="#" class="tip-bottom">Add Umrah Video</a> </div>
            <h1>Add Umrah Video</h1>
        </div>
                ...
                <div class="span12">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="add_umrvdo.php" method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
